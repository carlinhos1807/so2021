...
int* mem_imprime()
{
  ...
  if(tamVetor > MEMORYSIZE){
    printf("tamanho do programa nao suportado, aumente o MEMORYSIZE !");
    return 0;
  }
...
int main(int argc, char *argv[argc])
{
  ...
  //recebe vetor do montador com o programa
  int prog1[MEMORYSIZE] = {2, 0, 7, 2, 10, 5, 17, 8, 20, 1,9, 8, 11, 17, 18, 7, 1, 0, -1, -1};
  int prog2[MEMORYSIZE] = {2, 0, 7, 19, 0, 5, 17, 8, 20, 1,9, 8, 11, 17, 18, 7, 1, 0,-1,-1};
  int prog3[MEMORYSIZE] = {2, 0, 7, 2, 10, 5, 17, 8, 20, 1,9, 8, 11, 17, 18, 7, 1, 0, -1, -1};
  int prog4[MEMORYSIZE] = {2, 0, 7, 2, 10, 5, 17, 8, 20, 1,9, 8, 11, 17, 18, 7, 1, 0, -1, -1};
  /*
  ...
  so_inicializa_programa(so, prog1);
  so_inicializa_programa(so, prog2);
  so_inicializa_programa(so, prog3);
  so_inicializa_programa(so, prog4);
